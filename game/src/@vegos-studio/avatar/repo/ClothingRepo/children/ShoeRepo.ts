...
import { ShoeType } from "@vegos-studio/avatar/types/ClothingType";

export interface ShoeRepoItem extends Asset {}

export class ShoeRepo extends Repo<ShoeRepoItem> {
  constructor() {
    const parts: [string, ShoeRepoItem][] = [];

    parts.push(...ShoeRepo.getAllShoes());
